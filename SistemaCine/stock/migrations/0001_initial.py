    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipopago', models.CharField(blank=True, help_text='Elegir forma de pago de la/s recepcion/es de productos', max_length=20, choices=[('CONTADO', 'Contado'), ('AMORTIZADO', 'Amortizado')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket', models.FileField(null=True, upload_to='tickets', blank=True)),
